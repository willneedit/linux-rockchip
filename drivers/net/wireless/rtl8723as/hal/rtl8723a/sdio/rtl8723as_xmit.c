...
//		_exit_critical_bh(&phal->SdioTxFIFOFreePageLock, &irql);
		...
		{		
			if (n > 5000) {
				...
				DBG_8192C(KERN_NOTICE "%s: TXDMA STATUS=0x%x\n",
					__func__,rtw_read32(padapter, REG_TXDMA_STATUS));
				DBG_8192C(KERN_NOTICE "%s: REG_VOQ_INFORMATION=0x%x\n",
					__func__,rtw_read32(padapter, REG_VOQ_INFORMATION));
				DBG_8192C(KERN_NOTICE "%s: REG_VIQ_INFORMATION=0x%x\n",
					__func__,rtw_read32(padapter, REG_VIQ_INFORMATION));
				DBG_8192C(KERN_NOTICE "%s: REG_BEQ_INFORMATION=0x%x\n",
					__func__,rtw_read32(padapter, REG_BEQ_INFORMATION));
				DBG_8192C(KERN_NOTICE "%s: REG_BKQ_INFORMATION=0x%x\n",
					__func__,rtw_read32(padapter, REG_BKQ_INFORMATION));
				DBG_8192C(KERN_NOTICE "%s: REG_MGQ_INFORMATION=0x%x\n",
					__func__,rtw_read32(padapter, REG_MGQ_INFORMATION));
				DBG_8192C(KERN_NOTICE "%s: REG_HGQ_INFORMATION=0x%x\n",
					__func__,rtw_read32(padapter, REG_HGQ_INFORMATION));
				DBG_8192C(KERN_NOTICE "%s: REG_BCNQ_INFORMATION=0x%x\n",
					__func__,rtw_read32(padapter, REG_BCNQ_INFORMATION));

				NumOfFreePage = SdioLocalCmd53Read4Byte(padapter, SDIO_REG_FREE_TXPG);
				DBG_8192C(KERN_NOTICE "%s: SDIO_REG_FREE_TXPG=0x%x\n",
					__func__,NumOfFreePage);
